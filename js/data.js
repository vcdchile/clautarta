...
const CURSOS = [
  {
    ...
    subtitulo: "El curso preferido: Emprende en tartaleteria desde tu casa",
    ...
    temas: [
	  ...
	  "Diferentes tipos de coberturas y ganache",
  ...
  },
  {
    ...
    temas: [
      "Masa Base ( quety)",
	  "Más de 14 recetas Premium ",
      "Rellenos cremosos a prueba de errores de fácil Preparación",
      "Diferentes tipos de coberturas y ganache",
  ...
  },
  {
    ...
    subtitulo: "9 recetas Complementarias de Horneados",
    imagen: "img/recetario3.jpg",
    descripcionCorta: "Tartas Horneadas a bajo costo.",
    descripcionLarga: "Tartas con sabores exclusivos de excelente venta, proceso muy rápido, especial para emprender a bajo costo.",
    temas: [
      "Masa Base ( quety)",
	  ...
	  "Soporte por grupo de wsp",
      "Sespaldo en grupo de telegram",
	  "Sespaldo en grupo de facebook",
    ],
    fotos: [
	  "img/re1.jpg",
	  "img/re2.webp",
  ...
  },
  {
    ...
    descripcionLarga: "Sin preservantes - sin conservantes - sin aromatizantes - sin colorantes - 100% natural. De costo muy económico y fácil preparación. Te apoyamos desde un principio por todas las plataformas, además de videos paso a paso",
    temas: [
  ...
  },
  {
    ...
    descripcionCorta: "Taller completo especial para emprender con cookies. Económico y fácil de preparar.",
    descripcionLarga: "Taller completo especial para emprender con cookies, económico y fácil de preparar. Larga duración y excelente recepción del público.",
    temas: [
  ...
  },
  {
    ...
    subtitulo: "Excelente opción para emprender en ventas al detalle y x mayor",
    imagen: "img/trufon.jpg",
    descripcionCorta: "Excelente opción para emprender en ventas al detalle y x mayor. Fácil de preparar y muy bajo costo de producción",
    descripcionLarga: "Una excelente opción para comenzar a emprender o aumentar tus ventas. Larga duración sin necesidad de refrigeración",
    temas: [
      "Receta Económica ",
      "Fácil Preparación",
      "Video paso a paso",
  ...
  },
  {
    ...
    descripcionLarga: "Con este taller podrás dominar completamente la nueva técnica de dulces de leche. Un innovador producto para ofrecer a sus clientes con sabores exclusivos. Los sabores y colores quedan a su creatividad. Les vamos a enseñar más de 5 sabores base.",
    temas: [
  ...
  },
  {
    ...
    descripcionCorta: "Receta mejorada para lograr un resultado fácil y económico.",
    descripcionLarga: "Receta mejorada para lograr un resultado fácil y económico. Aprenderás desde cero el proceso paso a paso en video y en pdf. Con esta receta podrás realizar además de tortas, pasteles y todo lo que tu creatividad lo permita",
    temas: [
  ...
  },
  {
    ...
    descripcionLarga: "Aprende a realizar la mejor focaccia y ciabatta sin amasar, con sabor a masa madre. Excelente sabor, de fácil preparación con un proceso muy cómodo y duradero. Se puede hasta congelar con una durabilidad de más de 1 mes.",
    temas: [
      "Principios de la focaccia y ciabatta",
      "Pre fermentos Poolish",
      "Podrás realizar con la misma mezcla tanto ciabatta como focaccia",
	  "Soporte por grupo de wsp",
      "Respaldo en grupo de telegram",
	  "Respaldo en grupo de facebook",
    ],
  ...
  },
  {
    ...
    subtitulo: "10 Recetas perfectas para tartas frías y horneadas",
    imagen: "img/masa.jpg",
    descripcionCorta: "10 Recetas perfectas para tartas frías y horneadas paso a paso.",
    descripcionLarga: "10 Recetas perfectas para tartas frías y horneadas paso a paso, testeadas y modificadas por nosotros. Siempre pensando en emprender con este producto.",
    temas: [
      ...
      "Masa Quety Masa - Saludable - Masa Avena - Masa Rápida - masa neutra - masa Brisee - Masa Frola - Masa Murbe - Masa Sucree",
...
const TESTIMONIOS = [
  ...
  },
  {
  ...
  },
   {
    ...
    quote: "Andrea <br>Wsp +56931094838<br>Cabrero" ,
  },
   {
    nombre: "Dulce Polita.",
    rol: "Alumna — Varios Cursos",
    ...
    quote: "Nicol <br>Wsp 56996715191<br>Hualpén" ,
  },
    {
    nombre: "Andrea",
    rol: "Alumna — Varios Cursos",
    ...
    nombre: "Leyla",
    rol: "Alumna — Varios Cursos",
    foto: "img/alumna-leyla.jpg",
    video:"https://www.tiktok.com/@clautartas/video/7488497327372504326",
    quote: "Leyla <br>Wsp +56945518119<br>Santiago" ,
  },
      {
    nombre: "Delicias de Any",
    rol: "Alumna — Varios Cursos",
    foto: "img/alumna-any.jpg",
    video:"https://www.tiktok.com/@clautartas/video/7488419037584608518",
    quote: "Luisa <br>Wsp +56981730959<br>Santiago" ,
  },
      {
    ...
    quote: "jaqueline <br>Wsp +56961472297<br>Santiago" ,
      ...
      {
    nombre: "Dulce Manzanita.",
    rol: "Alumna — Varios Cursos",
    foto: "img/alumna-manzana.jpg",
    video:"https://www.tiktok.com/@clautartas/video/7489269930001452343",
    quote: "Yasna <br>Wsp +56965799231<br>La Cruz" ,
  },
  ...
  },
{
    ...
    nombre: "Leyla",
    ciudad: "Santiago",
    contacto: "56945518119",
    detalle: "al detalle y x mayor.",
    link: "#",
    linkTexto: "Coordinar por WhatsApp",
  },
      {
    nombre: "Delicias de Any - Luisa",
    ciudad: "Santiago",
    contacto: "56981730959",
    detalle: "al detalle y x mayor.",
    link: "#",
    linkTexto: "Coordinar por WhatsApp",
  },
      {
    nombre: "Delicias La Abu - Jaqueline",
    ciudad: "Santiago",
    contacto: "56961472297",
    detalle: "al detalle y x mayor.",
    link: "#",
    linkTexto: "Coordinar por WhatsApp",
  },
